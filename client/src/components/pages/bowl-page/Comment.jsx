    ...
    <div className="bg-slate-300 rounded-2xl overflow-hidden my-4">
      <div className="block md:flex">
        <div className="mt-4 mb-2 md:my-0">
          <img src={comment.user.image} className={`h-52 w-52 object-cover rounded-xl ${(showEditForm) ? ("md:rounded-br-2xl md:rounded-tr-none md:rounded-tl-none md:rounded-bl-none") : ("md:rounded-none")}`}></img>
        </div>
